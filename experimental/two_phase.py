"""EXPERIMENTAL executor. Not part of commit_gate_core.

Contains an arbitrary mutation_callback. Do not persist its tickets.
Do not import this module from the public package.
"""
...
from commit_gate_core.canonical import SIGNED_FIELDS
from commit_gate_core.gate import (
    AuditSink,
    Clock,
    MutationCallback,
    NonceLedger,
...
class TwoPhaseCommit:
    """Prepare then apply. Experimental. Not gate logic."""
